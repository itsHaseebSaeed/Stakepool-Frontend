<template>
  ...
  <div
    ...
    id="scrtWithdrawModal"
    tabindex="-1"
    aria-labelledby="scrtWithdrawModal"
    aria-hidden="true"
  >
...
export default {
  ...
  mounted() {
    // this.scrtStakepoolGetAvailableForWithdrawl;
  },
  ...
  methods: {
    ...
    ...mapActions(useScrtStakepoolStore, [
      "scrtStakepoolGetAvailableForWithdrawl",
      "scrtStakepoolWithdraw",
    ...
    async withdraw_check(withdraw_amount) {
      ...
      if (bg_withdraw_amount.isGreaterThan(bg_available_tokens_for_withdrawl)) {
        ...
        let temp_array = await this.scrtStakepoolWithdraw(
